                    ...
                    <div>
                        <div class="offer-banner hover-effect">
                            <img src="{{ asset('assets/images/veg-3/value/1.png') }}"
                                class="img-fluid bg-img blur-up lazyload" alt="Oferta Fresh Vegetable">
                            ...
                            <div class="offer-box">
                                <a href="{{ url('/shop') }}" class="btn-category btn theme-bg-color text-white">
                                    View Offer
                                </a>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="offer-banner hover-effect">
                            <img src="{{ asset('assets/images/veg-3/value/2.png') }}"
                                class="img-fluid bg-img blur-up lazyload" alt="Oferta Organic Vegetable">
                    ...
                    <div>
                        <div class="offer-banner hover-effect">
                            <img src="{{ asset('assets/images/veg-3/value/3.png') }}"
                                class="img-fluid bg-img blur-up lazyload" alt="Oferta Fruit & Vegetables">
